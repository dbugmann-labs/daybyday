...
| [1033](1033-a-schedule-says-its-rhythm-in-words.md) | A schedule says its rhythm in the package's own words — "Mon, Wed, Sat", "Every 14 days", "The 25th", "3x a week" — and no payload accessor becomes public; extends ADR-1022 from a date to a rule |
