...
| [1044](1044-a-target-is-marked-and-what-offers-nothing-recedes.md) | A row that is a target carries an accent mark and a row that offers nothing fades whole; the tick kind gains an open circle, `chore/draw-kept`'s "no colour" is amended for the trailing mark alone, and grey stays reserved for kept |
| [1044](1044-a-target-is-marked-and-what-offers-nothing-recedes.md) | A row that is a target carries an accent mark and a row that offers nothing fades whole; the tick kind gains an open circle, and a kept row recedes as one thing — a struck-through dimmed name beside a grey checkmark, after one accent across both trailing marks was built, seen on a phone and reversed onto the recommendation this record had rejected. Grey stays reserved for kept, and the fade stays the only thing that means the day has not arrived |
| [1044](1044-a-target-is-marked-and-what-offers-nothing-recedes.md) | A row that is a target carries an accent mark and a row that offers nothing fades whole; the tick kind gains an open circle, and a kept row is a struck-through dimmed name beside a green checkmark — the mark's colour decided three times over two phone builds, accent then grey then green, so the trailing slot now says tap in accent, done in green and not-a-target in grey. Green is the closest this app has come to *Nothing congratulates you*, and the record carries the objection that was raised and overruled |
