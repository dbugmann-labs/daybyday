...
| [1023](1023-the-bundle-identifier-is-com-dbugmann-daybyday.md) | The bundle identifier is `com.dbugmann.daybyday`, fixed from the first install on a phone; changing it orphans the record |
