...
| [1033](1033-a-number-is-taken-back-by-naming-the-day.md) | A number is taken back by naming its commitment and its date, never the number — a mistyped weight must be clearable without reading it back; the tick keeps its by-value shape |
