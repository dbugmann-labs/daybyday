...
- [ ] 5.7 `a number the commitment refuses keeps nothing and leaves the day as it was`
...
- [ ] 8.1 `a commit on a day screen that is not keeping a record is told nothing on the row` —
