...
draws in is set, and it is the only place a person sets it.
...
to move one into a group the screen draws none of or to an offset that group does not have** and
