...
- [ ] 4.1 `docs/open-questions.md` § *Known gaps* gains one new bullet for `day-screen` holding every rule in `grill.md` answers 8, 9 and 11 and `design.md`'s reclassified 1717, in those groups, with C3 as unreachable at the seam — none dropped, none added
