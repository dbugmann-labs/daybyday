...
- [x] W.8 **The handover** — the seven pictures are posted to the PR with `gh pr comment --attach` before hand-back, and this box is ticked on that comment's URL — https://github.com/dbugmann-labs/daybyday/pull/296#issuecomment-5757855917
