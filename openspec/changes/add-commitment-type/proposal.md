...
answer is written up as **ADR-1013**, which this proposal undertook to do if it went this way. The
...
- **ADR:** `docs/adr/1013-a-commitment-is-kept-from-a-day.md`, written with this change and listed in
...
- **`docs/open-questions.md`:** two entries move, and neither is this change's to write. Under *Open
  ...
  *"and what a day before the commitment existed shows"* is settled by ADR-1013 and should be struck,
