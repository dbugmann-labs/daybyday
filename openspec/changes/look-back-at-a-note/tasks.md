...
- [ ] W.1 A *Journal* note commitment kept every day, notes entered on the day screen on about eight past days — short ones, and ones running past two lines — its look-back opened from the commitments screen: the count heading over one card per note, newest first, each under its day said in full, as "21 September 2026" is, short notes whole and long ones cut at two lines with an ellipsis
- [ ] W.2 The W.1 page after tapping one cut note: its card grown to the whole text, the cards below moved down under it, and the cut note beneath it still folded
- [ ] W.3 A note written with line breaks, opened, in the dark appearance (`xcrun simctl ui booted appearance dark` before the run): its lines as written, and the cards legible against the page
- [ ] W.4 A note commitment with no note: the head, the dates card and "No note yet.", with no count and no card
- [ ] W.5 A stopped *Journal* holding one note: the dates card's "KEPT UNTIL" row and "1 note" over its one card
