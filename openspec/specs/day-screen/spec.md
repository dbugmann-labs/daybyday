...
SHALL hold the day it is showing until it is moved or the app is shown again, and SHALL be moved
onto another day by nothing else, neither by time passing nor by a tick made on it; its today SHALL
be replaced only when the app is shown again.
...
it offers the way back to today*. A day screen MUST NOT read a clock to say its day, and SHALL go on
saying the day it was handed until it is moved, a day is picked, or the app is shown again. A tick
made on it MUST NOT change what it says the day is. It SHALL say its day whether or not it is
keeping a record or a roster.
