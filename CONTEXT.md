...
**Round** — one pass of a grill: the whole frontier asked at once, each question carrying the
answer it recommends, then the frontier recomputed from what comes back. A grill is rounds until
